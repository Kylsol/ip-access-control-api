...
// Import the configured Express app (without starting the server)
// and the Sequelize instance for database setup/teardown.
const { app, sequelize } = require('../app');

// Import the models needed to set up test data
